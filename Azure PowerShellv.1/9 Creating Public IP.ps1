# Creating a new Public IP address and attaching it to a Azure NIC
...
$subnetName="SubnetA"
#======================================================
# Creating the Public IP and assigning it in this step ====================
...
# attaching Public IP to a NIC interface ends here.
